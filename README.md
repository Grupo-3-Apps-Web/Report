...
| 8       | US-24         | Leer Testimonios de Clientes y Dueños     | Como visitante, quiero consultar testimonios y reseñas de clientes y dueños.                                                       | 2                                |
| 9       | US-21         | Acceso a la Landing Page                 | Como visitante, quiero acceder a la landing page para obtener más información sobre los productos y servicios ofrecidos.          | 2                                |
| 10      | US-22         | Ver Información del Producto             | Como visitante, quiero ver de manera clara y precisa de qué trata el producto para poder tomar una decisión informada.            | 2                                |
| 11      | US-10         | Visualizar las publicaciones de alquiler | Como usuario, quiero navegar en las publicaciones ya existentes de alquiler.                                                       | 3                                |
| 12      | US-11         | Ordenar el precio de los alquileres      | Como usuario, quiero poder ordenar los alquileres disponibles en base a su precio.                                                 | 3                                |
| 13      | US-12         | Reseñar publicaciones de alquiler        | Como usuario, quiero poder dejar reseñas sobre las publicaciones realizadas por los dueños                                         | 3                                |
| 14      | US-13         | Cargar documentos de garantía            | Como usuario, quiero poder cargar mis documentos personales en mi perfil para poder optar a alquilar o publicar.                   | 3                                |
| 15      | US-06         | Dashboard del usuario                    | Como usuario, quiero contar con un dashboard donde consultar mis vehículos publicados.                                             | 3                                |
| 16      | US-08         | Visualizar una publicación               | Como usuario, quiero ver el estado e información de una publicación ya creada.                                                     | 3                                |
| 17      | US-15         | Cancelar reserva de vehículo             | Como usuario, quiero tener la opción de cancelar una reserva de un vehículo para alquilar.                                         | 3                                |
| 18      | US-01         | Registro de Usuario                      | Como visitante, quiero registrarme en la aplicación para poder publicar mis vehículos o consultar opciones de alquiler.            | 3                                |
| 19      | US-05         | Cambiar el Idioma de la Aplicación       | Como usuario, quiero cambiar el idioma de la aplicación para poder utilizarla en mi idioma preferido.                              | 3                                |
| 20      | US-18         | Crear Perfil                             | Como usuario, quiero crear un perfil donde ingresar mi información personal.                                                       | 3                                |
| 21      | US-19         | Modificar Perfil                         | Como usuario, quiero modificar mi perfil para actualizar mi información.                                                           | 3                                |
| 22      | US-23         | Consultar los Modelos Disponibles        | Como visitante, quiero revisar parte del catálogo de opciones para alquilar vehículos.                                           | 3                                |
| 23      | US-07         | Creación de publicaciones                | Como usuario, quiero crear publicaciones para ofrecer mis vehículos en alquiler.                                                   | 5                                |
| 24      | US-04         | Personalizar Interfaz                    | Como usuario, quiero personalizar la interfaz de la aplicación para adaptarla a mis preferencias y necesidades.                    | 5                                |
| 25      | US-14         | Reserva de vehículo                      | Como usuario, quiero tener la opción de reservar un vehículo para alquilar.                                                        | 5                                |
| 26      | TS-20         | Solucionar Errores Reportados            | Como desarrollador, quiero corregir los errores del software notificados por el equipo de QA para mejorar la calidad del producto. | 8                                |
