...
<br> Josue Paiva:<br> TB1: Liderazgo del equipo, organización de reuniones, verificación de progreso del reporte y revisión de los mismos.</td>
<td>Josue Paiva:Ejercer liderazgo me permitió desarrollar habilidades de comunicación y dirección con el equipo, además de tomar decisiones y responsabilidades en todo momento</td>
  </tr>
  <tr>
...
<br> Josue Paiva:<br> TB1: Desarrollo del capítulo 1, Needfinding que incluye los journey maps, user personas, analisis competitivo y la formulacion de los user stories</td>
<br>Josue Paiva:<br> TB1: El primer entregable me permitio poner a prueba todos los conocimientos que vengo adquiriendo de diversos cursos como IHC, Diseño de patrones de software, etc.</td>
  </tr>
</table>
...
| US-04        | Personalizar Interfaz              |
| US-05        | Cambiar el Idioma de la Aplicación |

### **Epic 02: Creación y Visualización de Publicaciones**
| **Story ID** | **Título**                 |
|--------------|----------------------------|
| US-06        | Dashboard del usuario      |
| US-07        | Creación de publicaciones  |
| US-08        | Visualizar una publicación |
| US-09        | Eliminar una publicación   |

### **Epic 03: Navegación de Alquileres Disponibles**
| **Story ID** | **Título**                               |
|--------------|------------------------------------------|
| US-10        | Visualizar las publicaciones de alquiler |
| US-11        | Ordenar el precio de los alquileres      |
| US-12        | Reseñar publicaciones de alquiler        |

### **Epic 04: Reserva de vehículos**
| **Story ID** | **Título**                               |
|--------------|------------------------------------------|
| US-13        | Visualizar las publicaciones de alquiler |
| US-14        | Ordenar el precio de los alquileres      |
| US-15        | Reseñar publicaciones de alquiler        |

### **Epic 05: Interacción con la Landing Page**
| **Story ID** | **Título**                           |
|--------------|--------------------------------------|
| US-16        | Navegación por el Landing Page       |
| US-17        | Ver Información del Startup          |
